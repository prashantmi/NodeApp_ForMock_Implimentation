...
$(document).ready(function(){
  ...
  fromTimeInput="00:00";
  toTimeInput="23:59";
  $('.fromTimeInput').val(fromTimeInput);
  $('.toTimeInput').val(toTimeInput);
...
/*----------On Change in lab Name starts---------------------------------*/
  $('#labName').change(function() {
      ...
      if(labCode==0){
        $('#machineNameDiv').css({"display": "none"});
        $('#getData').css({"display": "none"});
        $('#machineTestReportList').css({"display": "none"});
        showHideLoding("no");
      }

      else {
        $('#machineNameDiv').css({"display": ""});
        $('#getData').css({"display": ""});
        showHideLoding("yes");
...
/*----------On Click Getdata Button starts---------------------------------*/
  $('#getData').click( function(){
    ...
    if(labCode!=0 && labCode!=null && labCode!="" && labCode!=0 && machineId!=0 && machineId!=null && machineId!=""){
      ...
      showHideLoding("yes");
      $('#machineTestReportList').css({"display": ""});
      AjaxGetMachineTestReportList(labCode, machineId, fromDate, toDate);
    }
...
function AjaxGetMachineTestReportList(labCode, machineId, fromDate, toDate){
     ...
     "language": {
      ...
      buttons: [
          ...
          { extend: 'pdfHtml5', className: "bg-dark text-white",
              title: 'Machine Test Report List', text: 'PDF',
              pageMargins: [ 0, 0, 0, 0 ],
              margin: [ 0, 0, 0, 0 ],
              alignment: 'center',
       ...
       "ajax": {
        "url": "/HISInvestigationG5/new_investigation/MachineTestReport.cnt?hmode="+_mode+"&labCode="+labCode+"&machineId="+machineId+"&fromDate="+fromDate+"&toDate="+toDate,
